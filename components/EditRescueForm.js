...
import { StyleSheet, View, Text, TimePickerAndroid, TimePickerAndroidOpenOptions, Picker } from 'react-native';
...
export default class EditRescueForm extends Component {
  ...
  componentWillMount() {
    ...
    this.setState({ location: market, boxes: boxes, weight: weight, tags: tags, expirationDate: expiration, listingId: listingId })
  }
